...
const useProtectPurchaseCard = () => {
  ...
  const setModifierActive = useSetRecoilState(modifierActiveAtom);
              ...
              return (
                <Collapsible
                  ...
                  trigger={
                    <BaseButton
                      onClick={() => (
                        setWarrantyActive(!warrantyActive),
                          ...
                          {value.map((item, i) => {
                            return (
                              <label key={i} className="mt-10">
                                ...
                                <p className="ml-10">
                                  with price of $ {item.total_price}
                                </p>
                              </label>
                            );
                          })}
