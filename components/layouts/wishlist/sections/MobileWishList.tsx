...
const MobileWishList = ({handelincreaseWishList,handelDecreaseWishList,moveWishListToCart}:Props) => {
  ...
  return (
    <div>
      {wishList.map(item => {
        return (
          <div key={item.id} className="md:mx-12 px-5 mb-10 py-5 sm:block lg:hidden shadow-[0_0_10px_rgba(0,0,0,0.25)]">
            ...
            <div className="flex sm:justify-center md:justify-between items-center py-5 border-b">
              <span className="text-xl font-semibold text-gray-1150 sm:hidden md:block">
                SIZE
              </span>
            ...
            <div className="flex sm:justify-center md:justify-between py-5 border-b">
              ...
              <div className="flex border flex-row sm:w-[50%] md:w-[20%] justify-around items-center">
                <BaseButton onClick={() =>item.id && handelDecreaseWishList(item.id)} className="bg-green-950 rounded-full w-4 h-4 flex justify-center items-center" >
                  <h1 className="mt-0.5">-</h1>
                </BaseButton>
                
              
                <h1 className="mt-1">2</h1>
                <BaseButton onClick={() =>handelincreaseWishList(item)} className="bg-green-950 rounded-full w-4 h-4 flex justify-center items-center" >
                  <h1 className="mt-0.5">+</h1>
                </BaseButton>
            ...
            <div className="flex justify-center  py-5">
              <BaseButton className="bg-white" onClick={() => item.id && moveWishListToCart(item.id)}>
