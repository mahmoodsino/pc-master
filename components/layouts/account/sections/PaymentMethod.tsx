...
import { OpenPaymentModelAtom,PaymentAtom } from '../../../../helper/state/index'
...
const PaymentMethod = () => {
    ...
    const[openPaymentModelState,setOpenPaymentModelState]=useRecoilState(OpenPaymentModelAtom)
  ...
  return (
    <div className='sm:w-[100%] md:w-[65%]'>
        ...
        <div className='flex justify-end mt-5'>
          <BaseButton onClick={() =>setOpenPaymentModelState(true)} className='font-medium px-7 py-2 bg-green-950 text-white rounded-full ' title='Add' />
        </div>
        <AddCardPaymentModel />
