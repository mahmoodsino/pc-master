            ...
            <div key={index}>
              ...
              >
                <div className="2xl:left-[500px] pb-10  text-left ml-10 mt-12">
                  ...
                  <div className="mt-10">
                    <BaseButton className="uppercase  text-lg font-bold hover:bg-gray-1300/90 bg-gray-1300 text-white px-3 py-2 rounded-full leading-5 tracking-[0.03em]">
                      {item.button_text}
                    </BaseButton>
                  </div>
                </div>
                ...
                <div className="md:block sm:hidden product-slider-img">
                  <img
                    className="w-56 h-56 product-slider-img"
                    src={item.img}
                  />
                </div>
              </div>
